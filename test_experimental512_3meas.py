...
parser.add_argument("--test_path",type=str,default="C:/Users/felip\Desktop/RS Project/Experiments/Experiment_24-05-2023/processed/coded/test5/" + str(rsize) +"/")
parser.add_argument("--save_path",type=str,default='./test_datasets/exp_24-05-2023/processed/coded/test5/r' + str(rsize) +'/')
