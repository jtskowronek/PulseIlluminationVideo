...
class cnnModel(nn.Module):
    def __init__(self,color_channels=1,units=2,dim=64,frames=8):
        ...
        self.invNet1 = StandardConv2D(in_channels = 3,out_channels=frames, window=5).cuda()
        self.invNet2 = StandardConv2D(in_channels = 3,out_channels=frames, window=5).cuda()
        self.invNet3 = StandardConv2D(in_channels = 3,out_channels=frames, window=5).cuda()
